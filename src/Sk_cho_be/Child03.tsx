...
const Child03 = () => {
  ...
  // Dữ liệu BMI theo thời gian cho bé 15 tuổi
  const bmiData = [
    { date: '01/01/2024', bmi: 19.2, weight: 52.1, height: 162 },
    { date: '01/03/2024', bmi: 19.5, weight: 53.2, height: 163 },
    { date: '01/05/2024', bmi: 19.8, weight: 54.0, height: 164 },
    { date: '01/07/2024', bmi: 20.0, weight: 54.5, height: 164 },
    { date: '01/09/2024', bmi: 20.2, weight: 55.0, height: 165 },
    { date: '01/11/2024', bmi: 20.3, weight: 55.5, height: 165 },
    { date: '18/12/2024', bmi: 20.5, weight: 55.8, height: 165 }
  ];
  ...
  const analyzeBMI = () => {
    ...
    // Phân loại BMI cho trẻ 15 tuổi (nam)
    let bmiCategory = '';
    let healthStatus = '';
    let riskLevel = '';
  ...
  const getExerciseRecommendations = () => {
    ...
    if (analysis.bmiCategory.includes('Thiếu cân')) {
      return {
        ...
        recommendations: [
          'Tập thể dục nhẹ nhàng 45-60 phút/ngày',
          'Đi bộ, đạp xe, bơi lội',
          'Chơi thể thao: Bóng đá, bóng rổ, tennis',
          'Tập yoga hoặc võ thuật',
          'Tránh tập quá sức'
        ],
        activities: ['Đi bộ', 'Đạp xe', 'Bơi lội', 'Bóng đá', 'Bóng rổ', 'Tennis', 'Yoga', 'Võ thuật'],
        frequency: '5-6 ngày/tuần, 45-60 phút/ngày',
      ...
      return {
        ...
        recommendations: [
          'Tập cardio 60-90 phút/ngày',
          'Chạy bộ, đạp xe, bơi lội',
          'Tập thể dục nhóm: Zumba, aerobic',
          'Chơi thể thao cường độ cao',
          'Kết hợp tập sức mạnh'
        ],
        activities: ['Chạy bộ', 'Đạp xe', 'Bơi lội', 'Zumba', 'Aerobic', 'Bóng đá', 'Bóng rổ', 'Tennis'],
        frequency: '6-7 ngày/tuần, 60-90 phút/ngày',
      ...
      return {
        ...
        recommendations: [
          'Tập thể dục đa dạng 45-60 phút/ngày',
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl p-8 mb-8 border border-green-200 animate-slide-up">
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
            ...
            <div className="flex-shrink-0">
              <div className="w-32 h-32 bg-gradient-to-br from-green-400 to-blue-600 rounded-full flex items-center justify-center text-white text-4xl font-bold shadow-xl animate-bounce-in">
                DA
              </div>
