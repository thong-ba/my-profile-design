...
const Child02 = () => {
  ...
  // Dữ liệu BMI theo thời gian cho bé 12 tuổi
  const bmiData = [
    { date: '01/01/2024', bmi: 17.2, weight: 36.1, height: 143 },
    { date: '01/03/2024', bmi: 17.5, weight: 36.8, height: 144 },
    { date: '01/05/2024', bmi: 17.8, weight: 37.2, height: 144 },
    { date: '01/07/2024', bmi: 17.9, weight: 37.5, height: 144 },
    { date: '01/09/2024', bmi: 18.0, weight: 37.8, height: 145 },
    { date: '01/11/2024', bmi: 18.0, weight: 38.0, height: 145 },
    { date: '20/12/2024', bmi: 18.1, weight: 38.2, height: 145 }
  ];
  ...
  const analyzeBMI = () => {
    ...
    // Phân loại BMI cho trẻ 12 tuổi (nữ)
    let bmiCategory = '';
    let healthStatus = '';
    let riskLevel = '';
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl p-8 mb-8 border border-green-200 animate-slide-up">
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
            ...
            <div className="flex-shrink-0">
              <img src="/girl.png" alt="Girl" className="w-32 h-32 mx-auto mb-4 animate-bounce-in" />
              <div className="text-center">
